    ...
    return (
      <View style={[styles.msgWrapper, isMine ? styles.myMsgWrapper : styles.theirMsgWrapper]}>
        <View style={[styles.bubble, isMine ? styles.myBubble : styles.theirBubble]}>
          ...
          <Text style={[styles.msgTime, isMine && { color: "rgba(255,255,255,0.7)" }]}>{dayjs(item.created_at).format("HH:mm")}</Text>
        </View>
      </View>
    );
  };
...
const styles = StyleSheet.create({
  ...
  myBubble: { backgroundColor: "#00695c", borderBottomLeftRadius: 4 },
